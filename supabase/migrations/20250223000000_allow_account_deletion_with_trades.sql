-- Allow deletion of paper trading accounts even when they have associated trades
-- The foreign key constraint on trade_logs.account_id is set to "on delete set null",
-- so trades will remain but their account_id will be set to null when the account is deleted
